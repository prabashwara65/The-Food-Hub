        ...
        <div className="flex flex-col justify-between items-center h-full">
          ...
          >
            ...
            <p className="text-xl text-white-800 max-w-xl italic">
              Efficiently manage customer orders with real-time tracking and
              status updates. Simplify your workflow by overseeing all order
              activities from a single, centralized dashboard.
            </p>
          </div>
